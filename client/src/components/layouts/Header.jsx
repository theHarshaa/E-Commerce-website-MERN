...
<div className="items-baseline shadow-lg shadow-white-100/50 py-0 px-4 navbar">
      ...
      <nav>
        ...
        <SearchInput />
          <li className="text-base p-1 text-slate-700 rounded-lg hover:font-bold my-2 uppercase">
            <NavLink to="/" className="hover:no-underline text-lg">Home</NavLink>
          </li>
          <li className="nav-item dropdown text-base p-1 text-slate-700 rounded-lg hover:font-bold  my-2 uppercase">
 ...
 {categories?.map((c) => (
  <li><Link className="dropdown-item" to={`/category/${c.slug}`}>{c.name}</Link></li>
          ...
          <li className="text-base p-1 text-slate-700 rounded-lg hover:font-bold my-2 uppercase">
            <NavLink to="/login" className="hover:no-underline text-lg">Login</NavLink>
              ...
              <li  className="text-base p-1 text-tahiti text-slate-700 rounded-lg hover:font-bold my-2 uppercase">
              <div className="dropdown">
  ...
  <ul className="dropdown-menu">
  <li>
    <NavLink  to={`/dashboard/${auth?.user?.role === 1 ? "admin" : "user" }`} className="hover:no-underline text-lg p-1 text-slate-700 rounded-lg hover:font-bold my-2 uppercase" role="menuitem" tabIndex={-1} id="menu-item-0">Dashboard</NavLink>
    </li>
    <li><hr className="dropdown-divider" /></li>
    <li>
  <NavLink onClick={handleLogout} to="/login" className="hover:no-underline text-lg p-1 text-slate-700 rounded-lg hover:font-bold my-2 uppercase" role="menuitem" tabIndex={-1} id="menu-item-1">Logout</NavLink>
  </li>
  </ul>
</div>
              </li>
