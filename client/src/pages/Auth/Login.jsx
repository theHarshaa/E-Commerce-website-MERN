...
export default function Login() {
  ...
  <div className='mb-2'>
    ...
    <div className='mb-2'>
    <button type="button" onClick={() => {navigate("/forget-password")}} className="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline text-white btn-warning">Forget Password</button>
    </div>
